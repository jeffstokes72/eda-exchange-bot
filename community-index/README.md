...
## Release checklist (done for 0.13.3)

1. Current-version fields are **0.13.3**.
2. Tag `v0.13.3` was pushed; the Release workflow built
   `eda-exchange-bot-0.13.3.zip` with its `.sha256` asset:
   https://github.com/jeffstokes72/eda-exchange-bot/releases/tag/v0.13.3
3. Checksum
   `43585714e402d0e05ca1421d88bedbba739a622d6c6f2773fc29ac1102547f5c`
   is filled into `eda-exchange-bot.json` `sha256`. Re-verify with
   `sha256sum eda-exchange-bot-0.13.3.zip` if the archive is ever rebuilt.
